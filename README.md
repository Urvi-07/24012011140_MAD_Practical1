...
![Store and Display Values](screenshots/p1_1.png)  
  
### 1.2 Type Conversion  
Perform type conversions such as Integer → Double, String → Integer, and String → Double.    
![Type Conversion](screenshots/p1_2.png)  
...
![User Defined Function](screenshots/p1_6.png)  
  
### 1.7 Factorial Calculation with Recursion  
Calculate the factorial of a number using recursion.    
![Factorial](screenshots/p1_7.png)  
...
![Class and Constructor](screenshots/p1_10.png)  
...
![Matrix Operations](screenshots/p1_11b.png)     
